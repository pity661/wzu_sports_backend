...
/**
* GraphQL AreaActivityDataStatistic类型的定义及查询字段定义
* 
*/
@Controller
public class AreaActivityDataStatisticType {
    ...
    public static GraphQLObjectType getType() {
        if(type == null) {
            type = GraphQLObjectType.newObject()
                    .name("AreaActivityDataStatistic")
                    ...
                    .field(GraphQLFieldDefinition.newFieldDefinition()
                            ...
                            .build())
                    .field(GraphQLFieldDefinition.newFieldDefinition()
                            .name("locationAgainst")
                            .description("不在指定区域的采集点数量")
                            .type(Scalars.GraphQLInt)
                            .build())
                    .field(GraphQLFieldDefinition.newFieldDefinition()
                            .name("location")
