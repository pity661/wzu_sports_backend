...
public interface AreaActivityMapper {
	...
	@Insert({ "insert into wzsport_area_activity (area_sport_id, location_id, ", "student_id, cost_time, ",
			"start_time, ended_at, ", "ended_by, kcal_consumed, ", "qualified, is_valid, ",
			"is_verified, qualified_cost_time, ", "created_at, updated_at)",
			"values (#{areaSportId,jdbcType=BIGINT}, #{locationId,jdbcType=BIGINT}, ",
			"#{studentId,jdbcType=BIGINT}, #{costTime,jdbcType=INTEGER}, ",
			"#{startTime,jdbcType=TIMESTAMP}, #{endedAt,jdbcType=TIMESTAMP}, ",
			"#{endedBy,jdbcType=TINYINT}, #{kcalConsumed,jdbcType=INTEGER}, ",
	 ...
	 * @mbg.generated  Sat Mar 24 15:25:08 CST 2018
	 */
	@Select({ "select", "id, area_sport_id, location_id, student_id, cost_time, start_time, ended_at, ",
			"ended_by, kcal_consumed, qualified, is_valid, is_verified, qualified_cost_time, ",
			"created_at, updated_at", "from wzsport_area_activity", "where id = #{id,jdbcType=BIGINT}" })
