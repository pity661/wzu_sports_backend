...
public interface PhysicalTestMapper {
	...
	@Insert({ "insert into wzsport_physical_test (university_id, college_name, ", "grade_no, class_no, ",
			...
			"one_thousand_run_grade, is_tested, ", "is_free_test, total_score, ", "total_score_grade, is_pass, ",
			"school_year, term)", "values (#{universityId,jdbcType=BIGINT}, #{collegeName,jdbcType=VARCHAR}, ",
			...
			"#{isFreeTest,jdbcType=BIT}, #{totalScore,jdbcType=DECIMAL}, ",
			"#{totalScoreGrade,jdbcType=BIT}, #{isPass,jdbcType=BIT}, ",
	...
	@Select({ "select", "id, university_id, college_name, grade_no, class_no, class_name, student_no, ",
			...
			"total_score_grade, is_pass, school_year, term", "from wzsport_physical_test",
	...
	@Update({ "update wzsport_physical_test", "set university_id = #{universityId,jdbcType=BIGINT},",
			...
			"total_score_grade = #{totalScoreGrade,jdbcType=BIT},", "is_pass = #{isPass,jdbcType=BIT},",
