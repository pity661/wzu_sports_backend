...
public interface RunningActivityMapper {
    ...
    @Insert({ "insert into wzsport_running_activity (running_sport_id, end_running_sport_id, ",
            ...
            "ended_by)", "values (#{runningSportId,jdbcType=BIGINT}, #{endRunningSportId,jdbcType=BIGINT}, ",
    ...
    @Select({ "select", "id, running_sport_id, end_running_sport_id, student_id, distance, step_count, ",
            ...
            "start_time, kcal_consumed, qualified, is_valid, qualified_distance, qualified_cost_time, ",
            "min_cost_time, created_at, updated_at, ended_at, ended_by", "from wzsport_running_activity",
