...
public interface StudentStatisticViewMapper {
     ...
     * This method corresponds to the database table wzsport_student_statistic_view
     *
     ...
     */
    @Insert({
        "insert into wzsport_student_statistic_view (class_name, university_id, ",
        "user_type, open_id, ",
        "student_id, student_name, ",
        "student_no, is_man, class_id, ",
        "sign_in_count, running_activity_count, ",
        "area_activity_count, running_activity_qualified_count, ",
        "area_activity_qualified_count)",
     ...
     * @mbg.generated Wed Nov 15 15:06:04 CST 2017
     */
    int updateByExampleSelective(@Param("record") StudentStatisticView record, @Param("example") StudentStatisticViewExample example);
     ...
     * @mbg.generated Wed Nov 15 15:06:04 CST 2017
     */
    int updateByExample(@Param("record") StudentStatisticView record, @Param("example") StudentStatisticViewExample example);
}