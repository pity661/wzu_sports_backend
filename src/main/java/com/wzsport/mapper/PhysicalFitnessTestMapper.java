...
public interface PhysicalFitnessTestMapper {
	 ...
	 * @mbg.generated  Mon Nov 13 09:41:05 CST 2017
	 */
	@Insert({ "insert into wzsport_physical_fitness_test (university_id, gradle, ", "name, class_no, class_name, ",
			"college, isMan, ", "birth, nation_no, nation_name, ", "student_no, remark, ",
			...
			"one_thousand_level)", "values (#{universityId,jdbcType=BIGINT}, #{gradle,jdbcType=INTEGER}, ",
			"#{name,jdbcType=VARCHAR}, #{classNo,jdbcType=BIGINT}, #{className,jdbcType=VARCHAR}, ",
			"#{college,jdbcType=VARCHAR}, #{isman,jdbcType=TINYINT}, ",
			"#{birth,jdbcType=DATE}, #{nationNo,jdbcType=INTEGER}, #{nationName,jdbcType=VARCHAR}, ",
	 ...
	 * @mbg.generated  Mon Nov 13 09:41:05 CST 2017
	 */
	@Select({ "select", "id, university_id, gradle, name, class_no, class_name, college, isMan, birth, ",
	...
	@Update({ "update wzsport_physical_fitness_test", "set university_id = #{universityId,jdbcType=BIGINT},",
			"gradle = #{gradle,jdbcType=INTEGER},", "name = #{name,jdbcType=VARCHAR},",
			"class_no = #{classNo,jdbcType=BIGINT},", "class_name = #{className,jdbcType=VARCHAR},",
			"college = #{college,jdbcType=VARCHAR},", "isMan = #{isman,jdbcType=TINYINT},",
			"birth = #{birth,jdbcType=DATE},", "nation_no = #{nationNo,jdbcType=INTEGER},",
