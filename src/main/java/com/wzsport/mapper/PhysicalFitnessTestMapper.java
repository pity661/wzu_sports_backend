...
public interface PhysicalFitnessTestMapper {
	...
	@Insert({ "insert into wzsport_physical_fitness_test (university_id, gradle, ", "name, class_no, class_name, ",
			"college, sex, birth, ", "nation_no, nation_name, ", "student_no, remark, ",
			...
			"#{college,jdbcType=VARCHAR}, #{sex,jdbcType=VARCHAR}, #{birth,jdbcType=DATE}, ",
			"#{nationNo,jdbcType=INTEGER}, #{nationName,jdbcType=VARCHAR}, ",
	 ...
	 * @mbg.generated  Sun Nov 12 14:19:28 CST 2017
	 */
	@Select({ "select", "id, university_id, gradle, name, class_no, class_name, college, sex, birth, ",
	...
	@Update({ "update wzsport_physical_fitness_test", "set university_id = #{universityId,jdbcType=BIGINT},",
			...
			"college = #{college,jdbcType=VARCHAR},", "sex = #{sex,jdbcType=VARCHAR},",
